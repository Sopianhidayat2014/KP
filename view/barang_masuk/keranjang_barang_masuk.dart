...
import 'package:penyimpanan_barang/view/barang_masuk/tambah_barang_masuk.dart';
import 'package:penyimpanan_barang/view/barang_masuk/tambah_keranjang_barang_masuk.dart';
import 'package:shared_preferences/shared_preferences.dart';

class kerangjangbm extends StatefulWidget {
  @override
  State<kerangjangbm> createState() => _kerangjangbmState();
}

class _kerangjangbmState extends State<kerangjangbm> {
  var loading = false;
  final list = [];
  ...
  Future<void> _lihatdata() async {
    ...
    final respons = await http.get(Uri.parse(URL.urlcartbm));
  ...
  _proseshapus(String id) async {
    final respons =
        await http.post(Uri.parse(URL.urlhapuscbm), body: {"id": id});
    final data = jsonDecode(respons.body);
                ...
                : MaterialButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  new tambahbarangmasuk(_lihatdata)));
                    },
                    child: Text(
                      "Proses Data",
                      style: TextStyle(
