...
class laporanpage extends StatefulWidget {
  ...
  laporanpage({Key? key, required this.tanggal_model}) : super(key: key);

  @override
  State<laporanpage> createState() =>
      _laporanpageState(tanggal_model: tanggal_model);
}

class _laporanpageState extends State<laporanpage> {
   late tanggalmodel tanggal_model;
  _laporanpageState({required this.tanggal_model}) : super();
  final list = [];
  var loading = false;
