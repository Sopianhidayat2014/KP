...
class formlaporanbk extends StatefulWidget {
  const formlaporanbk({super.key});

  @override
  State<formlaporanbk> createState() => _formlaporanbkState();
}

class _formlaporanbkState extends State<formlaporanbk> {
  final _key = new GlobalKey<FormState>();
  send() {
    tanggalmodel tanggal_model = tanggalmodel("$tgl1", "$tgl2");
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => laporanpage(tanggal_model: tanggal_model)));
  }
